...
def get_mismatch_service(services: Annotated[Services, Depends(get_services)]) -> MismatchService:
    return services.mismatch
...
MismatchServiceDep = Annotated[MismatchService, Depends(get_mismatch_service)]
